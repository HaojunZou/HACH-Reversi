...
//        else{
//            algorithm.move(i, j);
//            messageBoy.sendMessage(socket, "move", position);
//            drawPiece(i, j);
//        }
//    }
//
...
////        if(arg.toString().startsWith("{\"show\"")){
////            String [] stringArray = arg.toString().replace("{\"show\":", "").replace("}", "").replace("[", "").replace("]", "").split(",");
////            System.out.println(Arrays.toString(stringArray) + "::" + stringArray.getClass());
////
////            for(int y=0; y<8; y++){
////                for(int x=0; x<8; x++){
////                    piece[x][y] = Integer.parseInt(stringArray[x + (y << 3)]);
////                }
////            }
////
////            System.out.println("after repaint: " + Arrays.deepToString(piece) + piece.getClass());
////            drawPiece(1, 1);
